...
export default function HeroComponent() {
  return (
    <div className="grid grid-cols-12 h-[681px] md:h-[425px] grid-rows-12 mb-4 mt-24 md:my-8 relative lg:w-[700px] lg:mx-auto xl:w-[1440px] xl:mx-auto">
      ...
      ">
        <Image
          ...
          className="w-[372px] h-[331px] md:w-[478px] md:h-[425px] rounded-3xl absolute -right-[25px] sm:left-[25] md:left-[75px] lg:left-[0] "
        />
      </div>
      <div className="hidden xl:block xl:absolute h-[240px] col-start-11 row-start-6 -right-[300px] top-[10px]">
